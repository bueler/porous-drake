...
parser.add_argument('-depth', type=float, default=50.0, metavar='D',
                    help='added depth below elevation 0 (problem extrude)')
parser.add_argument('-k_type', metavar='X', default='synth', choices=['synth','flat','verif'],
                    help='permeability structures: synth|flat|verif (problem 2d)')
...
if args.problem == '2d':
    ...
    zrescale = (ztop + args.depth) * z01 - args.depth  # z=-depth is bottom
    ...
    if False:
        ...
        u = Function(V, name='u(x,y)').interpolate(sin(y/100) + z)
        VTKFile('tmp.pvd').write(u)
